<p align="center">
  <a href="https://marketplace.visualstudio.com/items/boophy.claude-coder-chinese" target="_blank"><strong>Download Extension</strong></a> | <a href="https://discord.gg/Fn97SD34qk" target="_blank"><strong>Join the Discord</strong></a>
</p>
...
2. **Add Claude Coder**:
    ...
    - Search for ["Claude Coder"](https://github.com/boophy/claude-coder)
    - Click "Install"
3. **Start Coding**:
...
[Get Claude Coder Now](https://github.com/boophy/claude-coder) and start transforming your ideas into reality!
...
1. Clone the repo: `git clone https://github.com/boophy/claude-coder.git`
