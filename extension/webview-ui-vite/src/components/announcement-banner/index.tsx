			...
			<CardContent className="p-4 rounded-none">
				<div className="flex items-start justify-between">
					<div className="flex items-center gap-2">
						...
						<h2 className="text-sm font-semibold">{t("announcement.title")}</h2>
					</div>
					<Button
						variant="ghost"
						size="icon"
						...
						<X className="h-4 w-4" />
						<span className="sr-only">{t("announcement.dismiss")}</span>
					</Button>
				</div>
				...
				<Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
					...
					<CollapsibleContent className="mt-2 text-sm text-card-foreground space-y-2">
						...
						<p>{t("announcement.line5")}</p>
						<p>{t("announcement.line6")}</p>
					</CollapsibleContent>
					...
					<div className="mt-3 flex items-center gap-4">
						<CollapsibleTrigger asChild>
							<Button variant="ghost" size="sm">
								...
								{isExpanded ? t("announcement.showLess") : t("announcement.showMore")}
							</Button>
						</CollapsibleTrigger>
